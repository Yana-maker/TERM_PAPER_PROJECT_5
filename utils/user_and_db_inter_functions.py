from utils.api_class import Api_requests_about_employers_and_vacancies
from utils.db_inter_class import DBManager
from src.config import config
from utils.db_functions import create_database, execute_sql_script, read_json_file_employers, read_json_file_vacancy, insert_data_in_vacancy_table, insert_data_in_employee_table
import psycopg2


def database_interation() -> None:
...
def user_interaction(params):
    """Взаимодействие с пользователем и слздание vacancy-table таблицы с указанием ID компании """
